...
public class ConsultationController {
    ...
    public List<TestRequest> getForDoctor()  {
        ...
        User currDoctor =userLoggedInService.getLoggedInUser();

        return testRequestQueryService.findByDoctor(currDoctor);
    }
    ...
    public TestRequest assignForConsultation(@PathVariable Long id) {
        ...
        try {
            // replace this line of code with your implementation
            User curDoc =userLoggedInService.getLoggedInUser();

            return testRequestUpdateService.assignForConsultation(id, curDoc);
    ...
    public TestRequest updateConsultation(@PathVariable Long id,@RequestBody CreateConsultationRequest testResult) {
        ...
        try {
            ...
            return testRequestUpdateService.updateConsultation(id, testResult, curDoc);
